...
const WebDevCard = ({ hidden, image, title, about, liveLink, github, techList, progress, range, targetScale }) => {
        ...
        <div className='w-full lg:w-[50%] flex flex-col justify-between'>
          <div className='flex flex-col gap-5'>
            ...
            <div className='grid grid-cols-3 w-full gap-4 lg:gap-20'>
              <div onClick={handlePrevImage} className='col-span-1 flex justify-center items-center gap-3 bg-primary rounded-xl py-2 border-2 border-[#ffffff5a] text-accent cursor-pointer'>
                <i className='fas fa-arrow-left'></i>
              </div>
              <div onClick={() => setOpen(true)} className='col-span-1 flex justify-center items-center gap-3 bg-[#68ff688f] rounded-xl py-2 border-2 border-[#ffffff5a] cursor-pointer'>
                All Photos <i className='fas fa-image'></i>
              </div>
              <div onClick={handleNextImage} className='col-span-1 flex justify-center items-center gap-3 bg-primary rounded-xl py-2 border-2 border-[#ffffff5a] text-accent cursor-pointer'>
