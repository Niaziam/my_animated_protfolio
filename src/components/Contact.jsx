        ...
        >
          <label className='flex flex-col'>
            ...
            <input
              ...
              className='bg-primary py-4 px-6 placeholder:text-secondary text-white-100 rounded-lg outline-none border-none font-medium'
            />
          </label>
          <label className='flex flex-col'>
          ...
          <button
            type='submit'
            className='bg-primary py-3 px-8 rounded-xl outline-none w-fit text-light font-bold'
          >
