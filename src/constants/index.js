...
const experiences = [
  ...
  },
  {
    ...
    points: [
      "Enhancing search engine rankings through on-page SEO and technical optimization.",
      "Improving site performance by optimizing metadata, schema, and structured data.",
      "Conducting keyword research to align content with target audience needs.",
      "Monitoring analytics and implementing strategies for continuous performance improvement.",
    ],
  },
  {
    title: "Soft Skills",
